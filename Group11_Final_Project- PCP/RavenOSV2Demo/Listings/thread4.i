...
uint8_t task_stack_thread4[500]; osThreadDef_t os_thread_def_thread4 = { ( (uint8_t *) &(task_stack_thread4)), (thread4), (osPriorityBelowNormal), (500) };  
...
{     
    ...
    {	
        ...
        if (osSemaphoreWait (sid_Semaphore4, 0xFFFFFFFF) >= 0 )					
        {
