...
#line 10 "PCP_resource1.c"


osSemaphoreId Server1 = {0};                        
osSemaphoreDef_t os_semaphore_def_PCP_Semaphore1;                         
...
int Init_PCP_Semaphore1 (void) 
{  
  Server1 = osSemaphoreCreate(&os_semaphore_def_PCP_Semaphore1, 1);
  if (!Server1)  {
		return (-1);
  }
