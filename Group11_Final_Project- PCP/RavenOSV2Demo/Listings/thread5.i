...
uint8_t task_stack_thread5[500]; osThreadDef_t os_thread_def_thread5 = { ( (uint8_t *) &(task_stack_thread5)), (thread5), (osPriorityLow), (500) };  
  ...
  {	
      ...
      printf(" Task5: Hello!\n\r");
			...
			printf("Task5: Locking Server1 ! with priority %d\n\r", Server1->priority);
   			...
   			Timer_Enable(0x40031000, 0x000000ff);
					
		  
		  if (PCP_Semaphore_Wait (Server1, 0xFFFFFFFF) >= 0 )
			{
         
         
					Problem1_tick = Timer_Get_Value(0x40031000, 0x000000ff);
						
				 
					Timer_Disable(0x40031000, 0x000000ff);				
				 ...
				 if (osSemaphoreRelease (sid_Semaphore4) != osOK)
         {
             ...
             while(1) { };
			   ...
			   Problem5_tick = Timer_Get_Value(0x40031000, 0x000000ff);
	 	  	 ...
	 	  	 if (osSemaphoreRelease (sid_Semaphore3) != osOK)
         {
             ...
             while(1) { };
			   ...
			   Problem2_tick = Timer_Get_Value(0x40031000, 0x000000ff);
