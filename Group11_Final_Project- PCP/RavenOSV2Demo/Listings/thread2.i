...
uint8_t task_stack_thread2[500]; osThreadDef_t os_thread_def_thread2 = { ( (uint8_t *) &(task_stack_thread2)), (thread2), (osPriorityAboveNormal), (500) };  
        ...
        if (osSemaphoreWait (sid_Semaphore2, 0xFFFFFFFF) >= 0 )
        {
			   	...
			   	printf("Task2: Locking Server1 ! \n\r");
					...
					if (PCP_Semaphore_Wait (Server1, 0xFFFFFFFF) >= 0 )
					{
					  ...
					  Problem4_tick = Timer_Get_Value(0x40031000, 0x000000ff);
					  ...
					  if (PCP_Semaphore_Release (Server1) != osOK)
            {
                ...
                while(1) { };
					  ...
					  Problem3_tick = Timer_Get_Value(0x40031000, 0x000000ff);
