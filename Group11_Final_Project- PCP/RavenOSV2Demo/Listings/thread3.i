#line 1 "RTE\\Application\\source\\thread3.c"
...
#line 7 "RTE\\Application\\source\\thread3.c"
...
#line 8 "RTE\\Application\\source\\thread3.c"
...
#line 9 "RTE\\Application\\source\\thread3.c"

 
uint8_t task_stack_thread3[500]; osThreadDef_t os_thread_def_thread3 = { ( (uint8_t *) &(task_stack_thread3)), (thread3), (osPriorityNormal), (500) };
...
{	
    ...
    {	
        ...
        if (osSemaphoreWait (sid_Semaphore3, 0xFFFFFFFF) >= 0 )
        {
					printf(" Task3: Hello!\n\r");
