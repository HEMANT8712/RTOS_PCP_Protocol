...
#line 11 "pce_resource2.c"
#line 12 "pce_resource2.c"
osSemaphoreId Server2 = {0};                        
osSemaphoreDef_t os_semaphore_def_pce_Semaphore2;              
...
int Init_pce_Semaphore2 (void) 
{
  ...
  Server2 = osSemaphoreCreate(&os_semaphore_def_pce_Semaphore2, 1);
  if (!Server2)  {
