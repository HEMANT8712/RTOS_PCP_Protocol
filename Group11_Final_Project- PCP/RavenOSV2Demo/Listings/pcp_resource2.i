...
#line 10 "PCP_resource2.c"
#line 11 "PCP_resource2.c"
osSemaphoreId Server2 = {0};                        
osSemaphoreDef_t os_semaphore_def_PCP_Semaphore2;              
...
int Init_PCP_Semaphore2 (void) 
{  
  Server2 = osSemaphoreCreate(&os_semaphore_def_PCP_Semaphore2, 1);
  if (!Server2)  {
		return (-1);
  }
